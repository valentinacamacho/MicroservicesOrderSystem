  ...
  <ol>
    <li>
      <a href="#about-the-project">Acerca del proyecto</a>
       <ul>
        <li><a href="#built-with">Objetivo del proyecto</a></li>
      </ul>
      <ul>
        <li><a href="">Tecnologías Utilizadas</a></li>
      </ul>
    </li>
    <li>
...
cuando se usa Docker Compose, las dependencias de Node.js como:(`èxpress`,`amqplib`,`dotenv`) se instalan automaticamnte dentro del contenedor Docker durante la fase de construcción de la imagen es definida por: `Dockerfile de order-service`
    ...
    nota si, por alguna razón quisieras ejecutar el `order-service` directamenrte en tu máquina local (sin Docker)  para depuración o desarrollo especifico, entonces si considero que necesites ir al directorio `order-service` y ejecutar lo siguiente: 
